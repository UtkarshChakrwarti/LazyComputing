	...
	**/
	var isDragged		= false,
		...
		templates 		= {
							...
							buttonReset 	: $('<br><br><button id="bcPaint-reset"class="dbr">Reset</button>'),
							buttonSave		: $('<button id="bcPaint-export"class="db">Insert</button>')
						},
		paintCanvas,
		paintContext;
	...
	$.extend(true, $.fn.bcPaint, {
		...
		*/
		export : function(){
			...
			document.getElementById('rte').innerHTML+="<img width='300px'height='150px'src=" + imgData + " alt='Quick Sign'/>";
		},
...
getElementById('bcPaint').bcPaint();
